...
class ThaiBoardTest {
    ...
    @Test
    void isBoardOK() {
        AbstractBoard board = new ThaiBoard();
        ...
        assertSame(board.getFieldAt(2, 0).getColor(), Color.NONE);
        assertSame(board.getFieldAt(2, 2).getColor(), Color.NONE);
        assertSame(board.getFieldAt(2, 4).getColor(), Color.NONE);
        assertSame(board.getFieldAt(2, 6).getColor(), Color.NONE);
